...
export type PostMediaFragment = {
    ...
    mime?: string | null;
    image_link: string;
} & { " $fragmentName"?: "PostMediaFragment" };
...
export type PostThumbnailFragment = {
    ...
    width: number;
    height: number;
} & { " $fragmentName"?: "PostThumbnailFragment" };
...
export type GetPostQuery = {
    ...
    post?:
        | ({
              ...
              " $fragmentRefs"?: {
                  PostMediaFragment: PostMediaFragment;
                  PostMetadataFragment: PostMetadataFragment;
              };
          })
        | null;
};

export type PostScoreFragment = {
    __typename?: "Post";
    post_id: number;
    score: number;
    my_vote: number;
} & { " $fragmentName"?: "PostScoreFragment" };
...
export const PostMediaFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PostMedia" },
            typeCondition: {
                kind: "NamedType",
...
} as unknown as DocumentNode<PostMediaFragment, unknown>;
...
export const PostScoreFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PostScore" },
            typeCondition: {
                kind: "NamedType",
                name: { kind: "Name", value: "Post" },
            },
...
} as unknown as DocumentNode<PostScoreFragment, unknown>;
export const PostMetadataFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
        ...
        ...PostScoreFragmentDoc.definitions,
    ],
} as unknown as DocumentNode<PostMetadataFragment, unknown>;
...
export const GetCommentedPostsDocument = {
    ...
    definitions: [
        ...
        ...PostMediaFragmentDoc.definitions,
...
export const GetPostsDocument = {
    ...
    definitions: [
        ...
        ...PostThumbnailFragmentDoc.definitions,
    ],
...
export const GetPostDocument = {
    ...
    definitions: [
        ...
        ...PostMediaFragmentDoc.definitions,
        ...PostMetadataFragmentDoc.definitions,
        ...CommentFragmentFragmentDoc.definitions,
    ],
...
export const LoginDocument = {
    ...
    definitions: [
        ...
        ...UserLoginFragmentDoc.definitions,
    ],
