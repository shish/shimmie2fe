...
export type GetTagsQuery = {
    __typename?: "Query";
    tags: Array<{ __typename?: "TagUsage"; tag: string; uses: number }>;
};
...
export type CommentFragmentFragment = {
    ...
    comment_id: number;
    comment: string;
    owner: { __typename?: "User"; name: string; avatar_url?: string | null };
...
export type CreatePrivateMessageMutation = {
    __typename?: "Mutation";
    create_private_message: boolean;
};

export type PostMediaFragmentFragment = {
    __typename?: "Post";
    mime?: string | null;
    image_link: string;
} & { " $fragmentName"?: "PostMediaFragmentFragment" };
...
export type GetCommentedPostsQuery = {
    __typename?: "Query";
    posts: Array<
        {
            __typename?: "Post";
            ...
            comments: Array<
                { __typename?: "Comment" } & {
                    " $fragmentRefs"?: {
                        CommentFragmentFragment: CommentFragmentFragment;
                    };
                }
            >;
        } & {
            " $fragmentRefs"?: {
                PostMediaFragmentFragment: PostMediaFragmentFragment;
            };
        }
    >;
};
...
export type PostScoreFragmentFragment = {
    __typename?: "Post";
    post_id: number;
    score: number;
    my_vote: number;
} & { " $fragmentName"?: "PostScoreFragmentFragment" };
...
export type GetPostQuery = {
    ...
    post?:
        | ({
              ...
              " $fragmentRefs"?: {
                  PostMediaFragmentFragment: PostMediaFragmentFragment;
                  PostMetadataFragmentFragment: PostMetadataFragmentFragment;
              };
          })
        | null;
};
...
export type MeFragmentFragment = {
    ...
    avatar_url?: string | null;
    class: { __typename?: "UserClass"; permissions: Array<Permission> };
...
export const PostMediaFragmentFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PostMediaFragment" },
            typeCondition: {
                kind: "NamedType",
...
} as unknown as DocumentNode<PostMediaFragmentFragment, unknown>;
export const PostScoreFragmentFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PostScoreFragment" },
            typeCondition: {
                kind: "NamedType",
                name: { kind: "Name", value: "Post" },
            },
            selectionSet: {
                ...
                selections: [
                    ...
                    { kind: "Field", name: { kind: "Name", value: "my_vote" } },
                ],
            },
        },
    ],
} as unknown as DocumentNode<PostScoreFragmentFragment, unknown>;
export const PostMetadataFragmentFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PostMetadataFragment" },
            typeCondition: {
                kind: "NamedType",
                name: { kind: "Name", value: "Post" },
            },
        ...
        ...PostScoreFragmentFragmentDoc.definitions,
    ],
} as unknown as DocumentNode<PostMetadataFragmentFragment, unknown>;
export const MeFragmentFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "MeFragment" },
            typeCondition: {
                kind: "NamedType",
            ...
            selectionSet: {
                ...
                selections: [
                    { kind: "Field", name: { kind: "Name", value: "name" } },
                    {
                        ...
                        name: {
                            kind: "Name",
                            value: "private_message_unread_count",
                        },
                    },
                    {
                        kind: "Field",
...
} as unknown as DocumentNode<MeFragmentFragment, unknown>;
    ...
    definitions: [
        {
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "create_comment" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "post_id" },
...
>;
export const CreatePrivateMessageDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "mutation",
            name: { kind: "Name", value: "createPrivateMessage" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: {
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "create_private_message" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "to_user_id" },
...
>;
export const GetCommentedPostsDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                {
                                    kind: "Field",
                                    name: { kind: "Name", value: "thumb_link" },
                                },
                                {
                                    kind: "Field",
                                    name: { kind: "Name", value: "tags" },
        ...
        ...PostMediaFragmentFragmentDoc.definitions,
        ...CommentFragmentFragmentDoc.definitions,
    ],
} as unknown as DocumentNode<
    GetCommentedPostsQuery,
    GetCommentedPostsQueryVariables
>;
    ...
    definitions: [
        {
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "create_vote" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "post_id" },
...
export const GetPostDocument = {
    ...
    definitions: [
        ...
        ...PostMediaFragmentFragmentDoc.definitions,
        ...PostMetadataFragmentFragmentDoc.definitions,
        ...CommentFragmentFragmentDoc.definitions,
    ],
...
export const LoginDocument = {
    ...
    definitions: [
        ...
        ...MeFragmentFragmentDoc.definitions,
    ],
...
} as unknown as DocumentNode<GetAllTagsQuery, GetAllTagsQueryVariables>;
...
} as unknown as DocumentNode<GetWikiQuery, GetWikiQueryVariables>;
