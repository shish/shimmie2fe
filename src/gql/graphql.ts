...
export type MeFragmentFragment = { __typename?: 'User', name: string, private_message_unread_count?: number | null, avatar_url?: string | null } & { ' $fragmentName'?: 'MeFragmentFragment' };
...
export type PostMetadataFragmentFragment = { __typename?: 'Post', tags: Array<string>, source?: string | null, locked: boolean, info: string, posted?: string | null, owner: { __typename?: 'User', name: string, avatar_url?: string | null } } & { ' $fragmentName'?: 'PostMetadataFragmentFragment' };

export type PostScoreFragmentFragment = { __typename?: 'Post', score: number, my_vote: number } & { ' $fragmentName'?: 'PostScoreFragmentFragment' };
...
export type GetPostQuery = { __typename?: 'Query', post?: (
    ...
    & { ' $fragmentRefs'?: { 'PostMetadataFragmentFragment': PostMetadataFragmentFragment;'PostScoreFragmentFragment': PostScoreFragmentFragment } }
  ) | null };
